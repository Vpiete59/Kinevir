        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            {loading ? (
              ...
              <>
                {/* Bouton Espace Admin (admin uniquement) */}
                {profile?.role === 'admin' && (
                  <Link
                    href="/admin"
                    className="hidden lg:flex items-center gap-2 px-3 py-2 text-orange-600 border border-orange-400 rounded-lg hover:bg-orange-50 transition-all duration-200 text-sm font-medium"
                  >
                ...
                {/* Bouton Espace Praticien (praticien ou admin) */}
                {(profile?.role === 'practitioner' || profile?.role === 'admin') && (
                  <Link
                    href="/practitioner"
                    className="hidden lg:flex items-center gap-2 px-3 py-2 text-[#4A9BA5] border border-[#4A9BA5] rounded-lg hover:bg-[#4A9BA5]/5 transition-all duration-200 text-sm font-medium"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
